...
export function FileClientTool({ tool }: { tool: ToolMeta }) {
  ...
  return (
    <div className={card()}>
      <p className="mb-4 flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50/70 px-4 py-3.5 text-xs leading-relaxed text-slate-600">🔒 Your file stays on your device — processed in your browser.</p>
      <label className="flex cursor-pointer flex-col items-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-6 py-10 transition-colors hover:border-blue-400">
