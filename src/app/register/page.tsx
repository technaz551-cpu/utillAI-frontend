  ...
  return (
    <main className="section-shell flex items-center justify-center py-16 md:py-24">
      <div className="w-full max-w-md rounded-[32px] border border-[var(--border)] bg-white p-8 shadow-xl">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-600">Create account</p>
        <h1 className="mt-3 text-3xl font-black tracking-[-0.06em] text-[var(--foreground)]">Sign up</h1>
        <p className="mt-2 text-sm text-slate-500">Start using UtilAI with a free account.</p>
